...
import { Alert, View, Text, FlatList, Button, StyleSheet, LayoutAnimation, useWindowDimensions, TouchableOpacity, Animated } from 'react-native';
import { FAB, List, IconButton, Snackbar, useTheme } from 'react-native-paper';
...
const styles = StyleSheet.create({
  ...
  searchInputContainer: {
    paddingHorizontal: 15,
    // Adjust the position to make the TextInput sit on the border
    marginTop: -32, // Pull the TextInput up to sit on the border
  },
  closeButton: {
    position: 'absolute',
    right: 5,
  ...
  searchInput: {
    ...
    fontSize: 18,
    padding: 18,
    paddingRight: 40, // Increase right padding to avoid text overlapping the button
    flex: 1,
    elevation: 5,
    shadowColor: '#000',
  ...
  bottomSection: {
    backgroundColor: '#FFFFFF', // Adjust the color to match your design
  },
  emptyContainer: {
    flex: 1,
    justifyContent: 'center',
